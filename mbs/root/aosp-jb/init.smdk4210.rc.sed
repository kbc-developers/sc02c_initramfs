...
# override kernel modules
    ...
    symlink /lib/modules/j4fs.ko /system/lib/modules/j4fs.ko
    symlink /lib/modules/logger.ko /system/lib/modules/logger.ko
    symlink /lib/modules/ntfs.ko /system/lib/modules/ntfs.ko
